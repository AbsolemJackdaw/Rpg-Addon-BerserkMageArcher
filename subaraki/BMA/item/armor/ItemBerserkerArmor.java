...
public class ItemBerserkerArmor extends ModeledArmor {
	...
	public ItemBerserkerArmor(ArmorMaterial enumArmorMaterial, EntityEquipmentSlot slot) {
		super(slot, enumArmorMaterial, "berserker_"+slot.getName());
	}

	@Override
	public String armorClassName() {
		return BmaItems.berserkerClass;
	}
	...
	protected void get3DArmorModel(EntityLivingBase entityLiving, ItemStack stack, EntityEquipmentSlot armorSlot){
		if (stack != ItemStack.EMPTY) {
			if (stack.getItem() instanceof ItemArmor) {
				...
				case HEAD:
				case LEGS:
					setArmorModel(AddonBma.proxy.getArmorModel(ClientProxy.berserker_rest));
					break;
				case FEET:
				case CHEST:
					setArmorModel(AddonBma.proxy.getArmorModel(ClientProxy.berserker_chest));
					break;
				default:
					break;
				}
	...
	public Item getLinkedShieldItem() {
		return BmaItems.shield_berserker;
	}
}